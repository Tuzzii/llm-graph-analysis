"""
Maximum Flow Evaluation
Success if model predicts max flow value exactly.
"""
...
def evaluate_file(path):
    ...
    with open(path, "r", encoding="utf-8") as f:
        for line in f:
            ...
            gt = item["ground_truth"]["flow_value"]
...
if __name__ == "__main__":
    files = glob.glob("results/answers/*/maximum_flow/*.jsonl")
